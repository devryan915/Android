...
public class MyToast extends Toast
{
	 ...
	 * @return
	 */
	public static MyToast show(Context context, CharSequence text, boolean isSound, int duration,int music)
	{
		...
		TextView tv = (TextView) v.findViewById(R.id.item_new_data_toast_message);
		tv.setText(text);
		result.setView(v);
