...
public class PersonalSportsActivity extends BaseActivity {

	private FragmentTabHost mTabHost;
	private LayoutInflater layoutInflater;
	private Class fragmentClasses[] = { MainFragment.class,
			SportsCurrentFragment.class, SportsHistoryFragment.class };
	private int mTabDrawable[] = { R.drawable.tab_main,
			R.drawable.tab_sports_cur, R.drawable.tab_sports_his };
	private int mTabText[] = { R.string.tab_main, R.string.tab_sports_cur,
			R.string.tab_sports_his };
	...
	private void initTab() {
		...
		mTabHost.setOnTabChangedListener(new OnTabChangeListener() {
			...
			public void onTabChanged(String tabId) {
				PersonalSportsActivity.this.setTitle(tabId);
				if (getString(mTabText[0]).endsWith(tabId)) {
					Intent intent = new Intent(PersonalSportsActivity.this,
