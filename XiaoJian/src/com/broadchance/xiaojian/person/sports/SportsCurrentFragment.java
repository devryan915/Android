...
public class SportsCurrentFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		int goal = getActivity()
				.getSharedPreferences(
						Constant.USER,
						getActivity().MODE_PRIVATE).getInt(Constant.SPORTS_GOAL, 0);
		pbar=(ProgressBar)rootView
				.findViewById(R.id.personalhealth_sports_progress);
		pbar.setProgress(goal/100);
		prblbl=(TextView)rootView
				.findViewById(R.id.personalhealth_sports_progresslbl);
		prblbl.setText("已完成："+goal);
						...
						dialog = CommonUtil.showSetGoalDialog(getActivity(),
								new CallBack() {
									...
									public void doBack(Object... params) {
										...
										editor.putString(Constant.SPORTS_GOAL,
												params[0].toString());
										editor.commit();
