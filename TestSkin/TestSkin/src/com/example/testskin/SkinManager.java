...
public class SkinManager {
	...
	public void initSkin() {
		String setSkinID = PreferencesManager.getInstance().getString(
				ConstantConfig.PREFERENCES_SKINID);
		// String setSkinID = PreferencesManager.getInstance().getString(
		// ConstantConfig.USER.getUserID()
		// + ConstantConfig.PREFERENCES_SKINID);
	...
	public String getString(String resName) {
		return resources.getString(resources.getIdentifier(resName, "string",
	 ...
	 * @return
	 */
	public float getDimen(String resName) {
		return resources.getDimension(resources.getIdentifier(resName, "dimen",
				curSkin.getSkinPkgName()));
	}
