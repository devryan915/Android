...
public class GPSUtil {
	 ...
	 * @throws Exception
	 */
	public static Location callGear(Context ctx, ArrayList<LocationCellInfo> cellIds)
			throws Exception {
		String result = "";
		JSONObject data = null;
		if (cellIds == null || cellIds.size() == 0) {
			GPSUtil.alert(ctx, "cell request param null");
			return null;
		}
		try {
	...
	public static String getResponseResult(Context ctx, String path,
			ArrayList<LocationCellInfo> cellInfos) throws UnsupportedEncodingException,
	 ...
	 * @param tm
	 */
	private static void cdma(ArrayList<LocationCellInfo> cellInfos, TelephonyManager tm) {
	 ...
	 * @param tm
	 */
	private static void union(ArrayList<LocationCellInfo> cellInfos, TelephonyManager tm) {
		GsmCellLocation location = (GsmCellLocation) tm.getCellLocation();
		LocationCellInfo info = new LocationCellInfo();
