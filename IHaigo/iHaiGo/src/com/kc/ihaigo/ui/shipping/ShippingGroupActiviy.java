...
public class ShippingGroupActiviy extends IHaiGoGroupActivity {
	// 用于管理本Group中的所有Activity
	public static ShippingGroupActiviy group;
	public String CurrenttActivitId = null;
	public Boolean DisplayTabHost = true;
	public String TAG = "ShippingGroupActiviy";
	...
	public void startiHaiGoActivity(Intent intent) {
		Class<IHaiGoActivity> parentClass = group.getCurrentActivity() == null ? null
	...
	public void startiHaiGoActivity(Intent intent,
		...
		IHaiGoMainActivity.main.setCurrentTab(IHaiGoMainActivity.SHIPPING);
	...
	protected void onResume() {
		...
		if (CurrenttActivitId != null) {
			if (checkLogin()) {
				...
				Intent in = new Intent(this, PersonalLoginActivity.class);
				in.putExtra("code", "");
				in.putExtra("flag", "ShippingActivity");
	...
	protected void onSaveInstanceState(Bundle outState) {
		...
		DisplayTabHost = IHaiGoMainActivity.tab_content.getVisibility() == View.VISIBLE ? true
				: false;
