/**
 * @Title: ShopCargroupActiviy.java
...
public class ShopCarGroupActiviy extends IHaiGoGroupActivity {
	// 用于管理本Group中的所有Activity
	public static ShopCarGroupActiviy group;
	public String CurrenttActivitId = null;
	public Boolean DisplayTabHost = true;
	public String TAG = "ShopCarGroupActiviy";
	@Override
	...
	public void startiHaiGoActivity(Intent intent,
		...
		IHaiGoMainActivity.main.setCurrentTab(IHaiGoMainActivity.SHOPCART);
