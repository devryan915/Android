...
public class UpdateLoginPasd extends IHaiGoActivity implements OnClickListener {

	private String TAG = "UpdateLoginPasd";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.update_login_pasd);
		initTitle();
		initComponents();
	}
	...
	private void initComponents() {
		enter_oldpasd = (EditText) findViewById(R.id.enter_old_login_pasd);
		enter_pasd = (EditText) findViewById(R.id.enter_login_pasd);
		enter_repasd = (EditText) findViewById(R.id.re_enter_login_pasd);
	}
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
			case R.id.title_left :
				intent.setClass(UpdateLoginPasd.this, AccountSafety.class);
			...
			case R.id.userlogin_tv_confirm :
				oldpassword = enter_oldpasd.getText().toString();
					...
					public void deal(String result) {
						...
						if (!TextUtils.isEmpty(result)) {
							...
							try {
								...
								Log.i(TAG, "/-----" + code);
								if ("0".equals(code)) {
									Toast.makeText(UpdateLoginPasd.this, "失败",
											0).show();
								} else if ("1".equals(code)) {
									Toast.makeText(UpdateLoginPasd.this, "成功",
											0).show();
									intent.setClass(UpdateLoginPasd.this,
											AccountSafety.class);
									intent.putExtra(
									...
									Toast.makeText(UpdateLoginPasd.this,
											"原密码错误", 0).show();
								}
