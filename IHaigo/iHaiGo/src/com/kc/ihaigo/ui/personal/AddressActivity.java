 ...
 * 
 */
public class AddressActivity extends IHaiGoActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.personal_add_address_info);
		initTitle();
		initComponents();
	}
	...
	public void onClick(View v) {
		...
		case R.id.title_right:
			...
			if (" ".equals(contacts)) {
				ToastUtil.showShort(AddressActivity.this, getResources()
...
//				ToastUtil.showShort(AddressActivity.this, "选中默认了.....");
				status = "2";
			} else {
//				ToastUtil.showShort(AddressActivity.this, "取消默认了.....");
				status = "1";
			}
			break;
		default:
