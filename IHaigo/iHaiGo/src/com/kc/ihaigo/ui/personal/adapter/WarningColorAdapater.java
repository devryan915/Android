...
public class WarningColorAdapater extends BaseAdapter {
	private JSONArray datas;
	private Context context;
	private int selectItem = -1;

	public WarningColorAdapater(Context context, JSONArray datas) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			holder.topictype.setText(data.getString("color"));
