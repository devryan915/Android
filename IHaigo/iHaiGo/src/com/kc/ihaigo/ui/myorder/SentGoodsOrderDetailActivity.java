...
/***
 * @deprecated  代购订单------------已发货订单详情
 * @author Lijie
 * */
public class SentGoodsOrderDetailActivity extends Activity implements OnClickListener {
	private String order_id;
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_sent_goods_order_detail);
		initView();
		initData();
	}
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		switch (v.getId()) {
		case R.id.order_detail_evaluate_merchant: // 评价商家
							...
							if (!TextUtils.isEmpty(result)) {
								...
								try {
									...
									if (jsobj.getJSONObject("code").equals(1)) {
										ToastUtil.showShort(
												SentGoodsOrderDetailActivity.this,
												"已提醒发货");
