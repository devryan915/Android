...
public class hiddenListView extends PullUpRefreshListView {
	 ...
	 * @param attrs
	 */
	public hiddenListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		mDelBtn = (Button) view.findViewById(R.id.button);
...
//								- mPopupWindowHeight / 2);
				...
				mDelBtn.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						if (mListener != null) {
							mListener.clickHappend(mCurrentViewPos, v);
//							mPopupWindow.dismiss();
	...
	public interface DelButtonClickListener {
		public void clickHappend(int position, View view);
	}
