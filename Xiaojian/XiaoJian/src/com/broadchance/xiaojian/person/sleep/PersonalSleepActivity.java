...
public class PersonalSleepActivity extends BaseActivity {

	private FragmentTabHost mTabHost;
	private LayoutInflater layoutInflater;
	private Class fragmentClasses[] = { MainFragment.class,
			SleepCurrentFragment.class, SleepHistoryFragment.class };
	private int mTabDrawable[] = { R.drawable.tab_main,
			R.drawable.tab_sleep_cur, R.drawable.tab_sleep_his };
	private int mTabText[] = { R.string.tab_main, R.string.tab_sleep_cur,
			R.string.tab_sleep_his };
	...
	private void initTab() {
		...
		mTabHost.setOnTabChangedListener(new OnTabChangeListener() {
			...
			public void onTabChanged(String tabId) {
				PersonalSleepActivity.this.setTitle(tabId);
				if (getString(mTabText[0]).endsWith(tabId)) {
					Intent intent = new Intent(PersonalSleepActivity.this,
